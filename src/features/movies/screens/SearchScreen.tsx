...
export default function SearchScreen() {
  ...
  const { query, setQuery, movies, loading, error, search, clear } = useMovieSearch();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput
          ...
          value={query}
          onChangeText={(text) => { setQuery(text); if (error) clear(); }}
        ...
        <TouchableOpacity style={styles.searchButton} onPress={() => void search()}>
      ...
      {!loading && error === "" && movies.length === 0 && (
        <View style={styles.center}>
          ...
          <Text style={styles.emptyText}>Search for a movie to get started.</Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  searchContainer: { height: 52, flexDirection: "row", alignItems: "center", backgroundColor: "#1E293B", borderRadius: 14, paddingLeft: 14, marginBottom: 20 },
  input: { flex: 1, color: "#FFFFFF", fontSize: 16, paddingHorizontal: 10 },
  searchButton: { height: 52, width: 52, backgroundColor: "#2563EB", borderTopRightRadius: 14, borderBottomRightRadius: 14, justifyContent: "center", alignItems: "center", marginLeft: 8 },
  ...
  emptyText: { color: "#94A3B8", fontSize: 16, textAlign: "center", marginTop: 12 },
